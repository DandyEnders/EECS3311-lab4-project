...
feature -- Command
	...
	move_explorer (d: COORDINATE)
		...
		do
			-- converting the coordinate to be wrapped
			destination_coord := (explorer.coordinate + d).wrap_coordinate (explorer.coordinate + d, [1, 1], [shared_info.number_rows, shared_info.number_columns])
